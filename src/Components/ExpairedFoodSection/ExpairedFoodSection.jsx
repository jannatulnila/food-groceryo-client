...
//   // Card variants for smooth entry animations
//   const cardVariants = {
//     hidden: { 
//       opacity: 0, 
//       y: 60,
...
//       >
//         <h2 className="text-3xl font-bold text-primary dark:text-[#FFC107] mb-2">
//           🚨 Expired Food Items
//         </h2>
//         <div className="w-24 h-1 bg-gradient-to-r from-red-400 to-red-600 mx-auto rounded-full mb-4"></div>
//         <p className="font-semibold text-gray-600 dark:text-gray-300 text-lg">
//           Total Expired Items: <span className="text-red-500 font-bold">({expairedFood.length})</span>
//         </p>
//       </motion.div>
...
//                 Great! No expired foods found.
//               </p>
//               <p className="text-gray-500 dark:text-gray-400 mt-2">
//                 All your food items are still fresh!
//               </p>
//             </motion.div>
//           ) : (
//             <motion.div
...
//                   className="group relative bg-gradient-to-br from-red-100 to-red-200 dark:from-red-800 dark:to-red-900 rounded-2xl shadow-lg overflow-hidden flex flex-col transform hover:scale-105 transition-all duration-300 hover:shadow-2xl"
//                   whileHover={{ 
//                     y: -8,
...
//                   {/* Expired Badge with Animation */}
//                   <motion.span 
//                     className="absolute top-3 right-3 bg-gradient-to-r from-red-600 to-red-700 dark:from-red-400 dark:to-red-500 dark:text-black text-white px-3 py-1.5 rounded-full text-xs font-bold shadow-lg z-10"
...
//                     <motion.h3 
//                       className="text-lg font-bold text-gray-800 dark:text-white line-clamp-2 group-hover:text-red-600 dark:group-hover:text-red-400 transition-colors duration-300"
//                       initial={{ opacity: 0 }}
//                       animate={{ opacity: 1 }}
...
//                         <span className="text-gray-800 dark:text-white bg-white dark:bg-gray-700 px-2 py-1 rounded-lg font-medium">
//                           {food.category}
//                         </span>
//                       </div>
...
//                       <div className="flex items-center justify-between">
//                         <span className="font-semibold text-gray-600 dark:text-gray-300">Expired:</span>
//                         <span className="text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-900/30 px-2 py-1 rounded-lg font-bold text-xs">
...
//                     {/* Action Button */}
//                     <motion.button
//                       className="mt-auto bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white px-4 py-2 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-md"
//                       whileHover={{ scale: 1.05 }}
//                       whileTap={{ scale: 0.95 }}
//                       onClick={() => {
//                         // Add your remove/dispose action here
//                         console.log('Remove expired food:', food._id);
//                       }}
//                     >
//                       🗑️ Dispose
//                     </motion.button>
...
//           <Link
//             to="/allExpiredFoods"
//             className="group relative px-8 py-3 bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary text-white font-semibold rounded-full transition-all duration-300 transform hover:scale-105 hover:shadow-xl"
//           >
//             <span className="relative z-10">View All Expired Foods</span>
//             <motion.div
...
//             ></motion.div>
//             <motion.span
//               className="absolute right-3 top-1/2 transform -translate-y-1/2 group-hover:translate-x-1 transition-transform duration-300"
//               animate={{ x: [0, 5, 0] }}
