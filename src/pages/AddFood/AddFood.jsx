...
const AddFood = () => {
  ...
  const handleAddFood = async (e) => {
    ...
    try {
      await axios.post(`${import.meta.env.VITE_API_URL}/add-food`, food, {
        withCredentials: true,
      });
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 py-12 px-6 flex items-center justify-center">
      <motion.div
        className="max-w-4xl w-full bg-white dark:bg-gray-800 rounded-3xl shadow-xl border border-gray-200 dark:border-gray-700 p-8 md:p-10"
      ...
      >
        ...
        >
          <h2 className="text-3xl md:text-4xl font-extrabold mb-3 text-gray-800 dark:text-gray-100">
            Add New Food Item 
          </h2>
          <p className="text-gray-600 dark:text-gray-400 text-lg">
            Keep your food inventory fresh and organized
          </p>
        </motion.div>
        ...
        <form onSubmit={handleAddFood} className="space-y-8">
              ...
              return (
                ...
                >
                  <label className="flex items-center gap-2 font-semibold text-gray-700 dark:text-gray-200">
                    <Icon className="text-primary" /> {field.label}
                  </label>
                  <input
                    type={field.type}
                    name={field.name}
                    ...
                    min={field.min}
                    required={field.required}
                    className="w-full rounded-xl border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 p-3 focus:ring-2 focus:ring-blue-400 outline-none transition-all duration-300"
                  />
                </motion.div>
              );
            })}
          ...
          >
            ...
            <select
              ...
              required
              defaultValue=""
              className="w-full rounded-xl border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 p-3 focus:ring-2 focus:ring-primary transition-all duration-300"
            >
              <option value="" disabled>
                Select a category
              </option>
          ...
          >
            <label className="flex items-center gap-2 font-semibold text-gray-700 dark:text-gray-200">
              <FaFileAlt className="text-primary" /> Description
            </label>
            <textarea
              name="description"
              rows="4"
              placeholder="Write a short description about the food item..."
              className="w-full rounded-xl border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 p-3 focus:ring-2 focus:ring-blue-400 transition-all duration-300 resize-none"
            ></textarea>
          </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  value={user?.email || ""}
                  readOnly
                  className="w-full rounded-xl bg-gray-100 dark:bg-gray-600 text-gray-600 dark:text-gray-200 p-3 cursor-not-allowed"
                />
              </div>
              <div>
                <label className="flex items-center gap-2 text-sm font-semibold text-gray-600 dark:text-gray-300">
                  <FaUser className="text-gray-400" /> Display Name
                </label>
                <input
                  type="text"
                  value={user?.displayName || "Anonymous User"}
          ...
          >
            <button
              type="submit"
              disabled={loading || isSubmitting}
              className={`w-full py-3 rounded-xl font-bold text-lg shadow-md text-white transition-transform duration-300 ${
                loading || isSubmitting
                  ? "bg-gray-400 cursor-not-allowed"
