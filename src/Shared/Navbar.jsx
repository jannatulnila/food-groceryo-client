        ...
        <nav className="hidden md:flex text-primary items-center gap-2">
          ...
          {user ? (
            ...
            <>
              <NavLink
                to="/login"
                className="px-4 py-2 bg-white text-primary font-semibold rounded-lg hover:bg-gray-50 transition-colors duration-200"
              >
                Login
              </NavLink>
              <NavLink
                to="/register"
                className="px-4 py-2 bg-primary/10 border border-primary/30 text-primary font-semibold rounded-lg hover:bg-white/20 transition-colors duration-200"
              >
                Register
              </NavLink>
            </>
